<template>
	<view class="qiun-columns">
		<view class="qiun-padding">
			<view class="qiun-tip" @tap="loadData()">更新温湿度光强曲线</view>
		</view>
			...
			refreshData(historyList){
				let Area = {
					...
					series: [{
						...
						"data":[],
						"color":"#ff5500",
						"area":[247.84999999999997,5,338.54999999999996,23]
						}]
				};
